...
def main(_):
    ...
    train_writer = tf.summary.FileWriter('/home/wogong/Models/tf-mstn/tensorboard/' + MODEL_NAME + '/wogong_02_0.5')
    ...
    Ttrain_preprocessor = BatchPreprocessor(
        ...
        for epoch in range(FLAGS.num_epochs):
            ...
            while step < train_batches_per_epoch:
                ...
                if gd % 5000 == 0 and gd > 0:
                    saver.save(sess, checkpoint_dir + '/model', global_step=gd)
